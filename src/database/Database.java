...
/**
 * Database class.
 * Contains logic for directly interacting with the database
 */
public class Database {		
	...
	/** The last result from a query*/
	private String[][] lastResult = null;

	/** The last results from a transaction */
	...
	/**
	 * Gets the last result from a query.
	 * Returns an empty array if no results were generated from query
	 *
	 ...
	 * Executes a single MySQL statement and stores the results in lastResult
	 *
	...
	/**
	 * Make transaction.
	 * Takes array of MySQL statements and executes them in order as a transaction.
	 * Stores the result of the trancsaction in lastResults
	 * 
	 * @param statements Array of MySQL statements
	 * @return true, if successful
	 */
	// Executes a transaction from list of statements
	public boolean makeTransaction(String[] statements){
		...
		try{
			...
			Cleaner.printMessage(e, "makeTransaction()");
			success = false;
		}finally{
			// close database connections and reenable autocommit
			try {
	...
	/**
	 * Initiate db.
	 * Used for testing, empties and reinitializes database
	 *
	 * @return true, if successful
	 */
